/// A list of NWS text products
///
/// Reference: https://forecast.weather.gov/product_types.php
#[derive(Debug)]
pub enum NWSProduct {
    /// ABV Rawinsone Data Above 100 Milibars
    ABV,

    /// ADA Alarm/Alert Administrative Flag
    ADA,
    ...
    /// ADV Generic Space Environment Avdvisory
    ADV,
